plot4 <- function(){
  ...
  par(mfrow=c(2,2))
  with(subsetdata, plot(subsetdata$DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
  with(subsetdata, plot(subsetdata$DateTime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
  ...
  with(subsetdata, plot(subsetdata$DateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
  dev.off()
}